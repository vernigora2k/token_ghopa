...
const Roadmap = () => {
  const items = [
    { title: "💩 Раздача 60% эмиссии", text: "Мы распределим 60% всех токенов среди холдеров крупнейших проектов в TON, таких как FPIBANK, VILARSO, GOVNO и других. Почему? Чтобы дать понять, что GHOPA везде!" },
    ...
    { title: "📢 10000 GHOPA за каждое сообщение в соцсетях", text: "Напиши о GHOPA в соцсетях, пришли скриншот и получи 10000 GHOPA! Чем больше постов, тем больше ЖОПЫ!" },
...
const HowToGetTokens = () => {
  return (
    <Section>
      ...
      <StepText>3️⃣ После проверки тебе начислят 10000 GHOPA за каждый скриншот на твой кошелёк.</StepText>
